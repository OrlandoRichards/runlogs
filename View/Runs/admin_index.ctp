<div class="runs index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('time_mm'); ?></th>
			<th><?php echo $this->Paginator->sort('time_ss'); ?></th>
			...
			<th><?php echo $this->Paginator->sort('health_zone_time_mm'); ?></th>
			<th><?php echo $this->Paginator->sort('health_zone_time_ss'); ?></th>
			<th><?php echo $this->Paginator->sort('fitness_zone_time_mm'); ?></th>
			<th><?php echo $this->Paginator->sort('fitness_zone_time_ss'); ?></th>
			<th><?php echo $this->Paginator->sort('power_zone_time_mm'); ?></th>
			<th><?php echo $this->Paginator->sort('power_zone_time_ss'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($run['Run']['time_mm']); ?>&nbsp;</td>
		<td><?php echo h($run['Run']['time_ss']); ?>&nbsp;</td>
		<td><?php echo h($run['Run']['avg_heart_rate']); ?>&nbsp;</td>
		<td><?php echo h($run['Run']['max_heart_rate']); ?>&nbsp;</td>
		<td><?php echo h($run['Run']['kcal_watch']); ?>&nbsp;</td>
		<td><?php echo h($run['Run']['health_zone_time_mm']); ?>&nbsp;</td>
		<td><?php echo h($run['Run']['health_zone_time_ss']); ?>&nbsp;</td>
		<td><?php echo h($run['Run']['fitness_zone_time_mm']); ?>&nbsp;</td>
		<td><?php echo h($run['Run']['fitness_zone_time_ss']); ?>&nbsp;</td>
		<td><?php echo h($run['Run']['power_zone_time_mm']); ?>&nbsp;</td>
		<td><?php echo h($run['Run']['power_zone_time_ss']); ?>&nbsp;</td>
		<td><?php echo h($run['Run']['kcal_runkeeper']); ?>&nbsp;</td>
		<td><?php echo h($run['Run']['climb_m']); ?>&nbsp;</td>
		<td><?php echo h($run['Run']['final_sprint_s']); ?>&nbsp;</td>
		<td>
		...
		<td><?php echo h($run['Run']['route_link']); ?>&nbsp;</td>
