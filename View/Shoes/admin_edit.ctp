...
<?php echo $this->Form->create('Shoe'); ?>
	<fieldset>
		<legend><?php echo __('Admin Edit Shoe'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Shoe.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Shoe.id'))); ?></li>
