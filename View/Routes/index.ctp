<div class="routes index">
	...
	<tr>
			...
			<th><?php echo $this->Paginator->sort('route_link'); ?></th>
                        <th><?php echo $this->Paginator->sort('total_km'); ?></th>
                        <th><?php echo $this->Paginator->sort('avg_km'); ?></th>
	...
	<tr>
		...
		<td><?php echo h($route['Route']['description']); ?>&nbsp;</td>
                <td><a href="<?php echo h($route['Route']['route_link']); ?>">Runkeeper</a> &nbsp;</td>
                <td><?php echo sprintf("%.1f",$route['Route']['total_km']); ?>&nbsp;</td>
                <td><?php echo sprintf("%.2f",$route['Route']['avg_km']); ?>&nbsp;</td>
		<td class="actions">
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Html->link(__('New Run'), array('controller' => 'runs', 'action' => 'add')); ?> </li>
                <li><?php echo $this->Form->postLink(__('Recalculate'), array('action' => 'recalculate_all')); ?> </li>
	</ul>
</div>
